...
public static class Poly2Mesh {
    ...
    /// <summary>
	/// Makes the integer array representation of the triangulation of the mesh from a polygon
	/// </summary>
	/// <returns>The vertex index array for the triangle aspect of a mesh.</returns>
	/// <param name="polygon">Polygon you want to triangulate.</param>
	public static int[] GetTriangulation(Polygon polygon)
    {
