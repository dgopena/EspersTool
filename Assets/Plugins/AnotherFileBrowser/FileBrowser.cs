...
namespace AnotherFileBrowser.Windows
{
    public class FileBrowser
    {
        ...
        /// <summary>
        /// FileDialog for picking a folder path (This method is an addition by Diego Peña)
        /// </summary>
        /// <param name="browserProperties">Special Properties of Folder Dialog</param>
        /// <param name="filepath">User picked folder path (Callback)</param>
        public void OpenFolderBrowser(BrowserProperties browserProperties, Action<string> filepath)
        {
            var ofd = new VistaFolderBrowserDialog();

            ofd.Description = browserProperties.title == null ? "Select a Folder" : browserProperties.title;
